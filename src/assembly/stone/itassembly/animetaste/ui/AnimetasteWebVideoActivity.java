...
public class AnimetasteWebVideoActivity extends BaseActivity implements RefreshSpeedListener, OnSeekBarChangeListener,
		OnGestureListener {
	...
	protected void getData() {
		...
		if (animetasteModel != null) {
			if(StringUtils.isNotEmpty(animetasteModel.getDetailPic())){
		...
		mediaPlayer.setMediaStatusCallback(new MediaStatusCallback.SimpleMediaStatusCallback() {
			...
			public void onError(int what, int extra) {
				...
				intent.setClass(AnimetasteWebVideoActivity.this, AnimetasteWebVideoActivity.class);
			...
			public void onStartPlay() {
				...
				// isSeepbar = false;
				// startSpeedThread();
				// mSeekBar.setProgress(Integer.valueOf(mAcache
				// .getAsString(animetasteModel.getName())));
				// refreshProgressBar(Integer.valueOf(mAcache
				// .getAsString(animetasteModel.getName())));
				// Log.e("mSeekBar.getProgress()", mAcache
				// .getAsString(animetasteModel.getName()));
				// }
			}
			...
			public void onTimeOut() {
				Log.d("releas", "release  onTimeOut");
				mediaPlayer.release();
				setPlay(View.VISIBLE);
				video_btn.setBackgroundResource(R.drawable.video_pause);
			}
			...
			public void onCompletion() {
				Log.d("releas", "release  onCompletion");
				mediaPlayer.release();
	...
	protected void onPause() {
		...
		// isSeepbar = true;
		videoPause();
		// lastTime = mediaPlayer.getPlayer()
		handler.removeMessages(HW_POSITION_SHOW);
		mediaPlayer.release();
	...
	private void startVedio() {
		...
		if (NetworkUtil.checkNetworkState(this)) {
			...
			if (mediaPlayer.getPlayer() == null) {
				...
				Log.d("mediaPlayer.getPlayer() == null", "mediaPlayer.getPlayer() == null");
			}
		} else {
			Log.d("else {", "else {");
	...
	private void videoPause() {
		try {
			...
			Log.e("mSeekBar.getProgress()", String.valueOf(mSeekBar.getProgress()));
	...
	private void setVolume(int currentVolume) {
		...
		Log.e("currentVolume", "currentVolume:" + currentVolume + " maxVolume:" + maxVolume + " " + (int) fla * 100);
	...
	protected void onActivityResult(int arg0, int arg1, Intent arg2) {
		...
		// mSeekBar.setProgress(Integer.valueOf(mAcache
		// .getAsString(animetasteModel.getName())));
		// refreshProgressBar(Integer.valueOf(mAcache.getAsString(animetasteModel
		// .getName())));
	}
